"""
Docstring para Python-Básico.aula58
...
Flat is better than nested. / Plano é melhor que aglomerado.
...
There should be one-- and preferably only one --obvious way to do it. / Deve haver um -- e só um -- modo óbvio para fazer algo.
Although that way may not be obvious at first unless you're Dutch. / Embora esse modo não passa não ser óbvio à primeira vista a menos que você seja holandês.
Now is better than never. / Agora é melhot que nunca.
Although never is often better than *right* now. / Embora nunca frequentemente seja melhor que *exatamente* agora.
...
Namespaces are one honking great idea -- let's do more of those! / Namespaces são uma grande ideia -- vamos fazer mais dessas!
